...
class StarshipInformationColector(StarshipsInformationColectorInterface):
    ...
    @classmethod
    def __format_response(cls, starhip_information: Dict, distance_traveled: int) -> Dict:
        return {
            "starship": starhip_information["name"],
            "model": starhip_information["model"],
            "manufacturer": starhip_information["manufacturer"],
            "max_atmosphering_speed": starhip_information["max_atmosphering_speed"],
            "MGLT": starhip_information["MGLT"],
